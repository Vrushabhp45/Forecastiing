...
# Loading Dataset
dataset = pd.read_excel('C:/Users/HP/PycharmProjects/Excelrdatascience/Airlines+Data.xlsx')
...
#AR MODEL
model = sm.tsa.arima.ARIMA(indexedDataset_logScale, order=(2,1,0))
...
#MA MODEL
model = sm.tsa.arima.ARIMA(indexedDataset_logScale, order=(0,1,2))
...
print('Plotting AR model')
model = sm.tsa.arima.ARIMA(indexedDataset_logScale, order=(2,1,2))
